...
export default function JobDescriptionInput({ onGenerate, isGenerating }: Props) {
  ...
  return (
    <div className="bg-surface/50 rounded-[2.5rem] border border-border-muted p-8 space-y-8">
      <div className="flex items-center justify-between">
        ...
        <p className="text-[10px] font-medium text-muted-foreground/80 italic">Provide job specifications for semantic alignment.</p>
      </div>

      {/* URL Input */}
      <div className="space-y-3">
        <label className="text-[10px] font-black text-muted-foreground/80 uppercase tracking-widest ml-2">Posting URL</label>
        <div className="flex gap-3">
          <div className="relative flex-1">
            <LinkIcon className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground/70" />
            <input
              type="url"
              value={urlInput}
              ...
              className="w-full pl-12 pr-5 py-4 bg-background border border-border-muted rounded-2xl text-sm font-medium text-foreground placeholder:text-muted-foreground/90 focus:outline-none focus:ring-1 focus:ring-foreground/10 transition-all"
            />
          </div>
          <button
      ...
      {/* Textarea */}
      <div className="space-y-3">
        <label className="text-[10px] font-black text-muted-foreground/80 uppercase tracking-widest ml-2">Raw Specification</label>
        <div className="relative group">
          <textarea
            ...
            rows={8}
            className="w-full px-6 py-6 bg-background border border-border-muted rounded-[2rem] text-sm text-foreground/80 placeholder:text-muted-foreground/90 focus:outline-none focus:ring-1 focus:ring-foreground/10 transition-all resize-none font-medium leading-relaxed"
          />
          <div className="absolute bottom-4 right-6 text-[10px] font-black text-muted-foreground/90 uppercase tracking-widest">
